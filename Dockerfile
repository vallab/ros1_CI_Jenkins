...
RUN /bin/bash -c "chmod +x /catkin_ws/src/tortoisebot_waypoints/test/waypoint_ros_test.py"
RUN /bin/bash -c "chmod +x /catkin_ws/src/tortoisebot_waypoints/test/waypoints_test.test" 
RUN /bin/bash -c "chmod +x /catkin_ws/src/tortoisebot_waypoints/src//tortoisebot_waypoints/tortoisebot_action_server.py"
